...
export default function Sidebar() {
    ...
    return (
        <aside className="static top-16 left-0 h-68 w-70 bg-gradient-to-b from-gray-900 to-gray-800 text-white p-6 shadow-2xl rounded transition-all duration-300 ease-in-out ">
