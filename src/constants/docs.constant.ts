            ...
            sections: [
                {
                    ...
                    content:
                        "Track real-time network metrics including transaction throughput, block production, and node performance.",
                    codeBlocks: [
                        {
...
export const docDocuments: DocDocument[] = [
    {
        ...
        description:
            "Learn the fundamentals of Cardano blockchain, its architecture, and how to get started with development.",
